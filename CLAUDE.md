...
- **Infra:** **nunca** modifique `Dockerfile`, `hermes-compose.local.yml`, `docker-compose.yaml` (stack de prod), configs de rede/volumes ou qualquer coisa de infra sem aprovação explícita do Fábio.
